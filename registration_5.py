...
with open("NEW_URL_5.txt", 'r', encoding='utf-8') as dicti:
...
def LinkUpdate():
    ...
    if user_choice == '1':
        ...
        if user_choice_confirmation == 'Y' or 'y' :
            with open('NEW_URL_5.txt','w', encoding='utf-8') as delete:
                delete.write('')
    ...
    if user_choice == '2':
        ...
        if dec == 'Y':
            with open('NEW_URL_5.txt', 'a', encoding='utf-8') as link:
...
def registration_data():
    ...
    while True:
        ...
        for no in scrims:
            ...
            # th_time = list(stored_data[scrim_no -1])
            # print(th_time)
